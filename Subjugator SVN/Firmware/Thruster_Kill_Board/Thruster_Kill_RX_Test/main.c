...
const uint8_t C_KILL_LEN = 5;
const uint8_t C_GO_LEN = 3;
const char Hard_Killed[C_KILL_LEN]   = "KRHA";    // 0x4B 0x52 0x48 0x41 0x00
const char Soft_Killed[C_KILL_LEN]   = "KRSA";    // 0x4B 0x52 0x53 0x41 0x00
const char Hard_UnKilled[C_KILL_LEN] = "KRHU";    // 0x4B 0x52 0x48 0x55 0x00
const char Soft_UnKilled[C_KILL_LEN] = "KRSU";    // 0x4B 0x52 0x53 0x55 0x00
const char Go_Asserted[C_GO_LEN]     = "GA";      // 0x47 0x41 0x00
const char Go_UnAsserted[C_GO_LEN]   = "GU";      // 0x47 0x55 0x00

/* RX MESSAGES */
const char Hard_Killed_CMD[C_KILL_LEN]   = "KCHA";    // 0x4B 0x43 0x48 0x41 0x00
const char Soft_Killed_CMD[C_KILL_LEN]   = "KCSA";    // 0x4B 0x43 0x53 0x41 0x00
const char Hard_UnKilled_CMD[C_KILL_LEN] = "KCHU";    // 0x4B 0x43 0x48 0x55 0x00
const char Soft_UnKilled_CMD[C_KILL_LEN] = "KCSU";    // 0x4B 0x43 0x53 0x55 0x00
...
//
//       tCANMsgObject CAN_KillBox;
//       tCANMsgObject CAN_MoboBox;
//
//       /*Kill Mail Object*/
//       CAN_KillBox.ui32MsgID = TKB_KILLID;
//       CAN_KillBox.ui32MsgIDMask = TKB_KILL_FILTID_bm;
//       CAN_KillBox.ui32Flags = MSG_OBJ_USE_ID_FILTER;
//       CAN_KillBox.ui32MsgLen = TKB_CAN_KILL_LEN;
//       CAN_KillBox.pui8MsgData = Kill_Data;
//
//       /*Mobot Mail Ojbect*/
//       CAN_MoboBox.ui32MsgID = TKB_MOBOID;
//       CAN_MoboBox.ui32MsgIDMask = TKB_MOBO_FILTID_bm;
//       CAN_MoboBox.ui32Flags = MSG_OBJ_USE_ID_FILTER;
//       CAN_MoboBox.ui32MsgLen = TKB_CAN_MOBO_LEN;
//       CAN_MoboBox.pui8MsgData = Mobo_Data;

    //INIT KILLBOX
//    CANMessageSet(TKB_CAN_BASE,TKB_CAN_KILL_OBJ,&CAN_KillBox,MSG_OBJ_TYPE_RX);
//
//    //INIT MOBOBOX
//    CANMessageSet(TKB_CAN_BASE,TKB_CAN_MOBO_OBJ,&CAN_MoboBox,MSG_OBJ_TYPE_RX);

    /**************************************CAN INIT END********************/

    /**************************************UART DBG INIT START********************/

     MIL_InitUART(UART5_BASE,MIL_DEFAULT_BAUD_115K);
    ...
    while(1){
       ...
       if(MIL_CAN_CheckMail(&CAN_KillBox)== MIL_CAN_OK){
           ...
           MIL_CAN_GetMail(Kill_Data,&CAN_KillBox);
