...
/********DEFINES START******/
#define CANID_RX        0x51   //ID we wish to filter for,task group = 3, ECU = 7
#define CANID_TX        0x53   //our ECUs ID will will transmit with, task group = 3, ECU = 7
#define CAN_MSG_LEN_8    0x4    //CAN message lengths
...
int main(void){
     ...
     *
     */
    MailBox.filt_mask = 0xF0;   //set filt mask to don't care
